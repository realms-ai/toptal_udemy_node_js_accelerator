...
import { CartItem, CartItemType } from './cart-item.js';
import { Cart } from './cart.js';
import { OrderItem, OrderItemType } from './order-item.js';
...
class Product extends Model {
  ...
  declare CartItem: Partial<CartItem>;
  declare OrderItem: Partial<OrderItem>;
