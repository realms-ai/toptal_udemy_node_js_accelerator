import { authController, authRouter, checkAuthorizationHeader, } from '../config/middleware.js';
...
describe('Testing Auth Middleware', () => {
    it('should throw error if authorization header is not present', async () => {
        ...
        const res = 5;
        const next = () => { };
        expect(checkAuthorizationHeader.bind(this, req, () => { })).to.throw('Not authenticated');
        authController(req, res, () => { }).then((response) => {
